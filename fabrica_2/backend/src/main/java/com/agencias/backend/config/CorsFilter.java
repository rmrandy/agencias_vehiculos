...
public class CorsFilter implements ContainerRequestFilter, ContainerResponseFilter {
    ...
    private static void setCorsHeaders(MultivaluedMap<String, Object> headers) {
        ...
        headers.putSingle(ALLOW_HEADERS, "Content-Type, Authorization, X-Admin-User-Id, X-Distributor-Api-Key");
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        if ("OPTIONS".equalsIgnoreCase(requestContext.getMethod())) {
            Response response = Response.noContent()
                ...
                .header(ALLOW_HEADERS, "Content-Type, Authorization, X-Admin-User-Id, X-Distributor-Api-Key")
