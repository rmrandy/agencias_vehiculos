...
-- =============================================================================
-- Notas
-- - APP_USER: PK = USER_ID. AppUser.java debe usar @Column(name = "USER_ID").
--   Si Hibernate (hbm2ddl=update) creó también la columna USERID, ejecute
--   database/10_app_user_drop_redundant_userid.sql como FABRICA2.
